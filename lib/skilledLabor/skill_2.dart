...
class Skill1Page extends StatefulWidget {
  const Skill1Page({super.key});

  @override
  State<Skill1Page> createState() => _Skill1PageState();
}

class _Skill1PageState extends State<Skill1Page> {
  void goBack() {
